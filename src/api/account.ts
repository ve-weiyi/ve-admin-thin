...
/** 获取用户地区列表 */
export function findUserAreaListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<UserAreaDTO[]>>> {
...
/** 批量删除登录历史 */
export function deleteUserLoginHistoryByIdsApi(
  data: number[]
