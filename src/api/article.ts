...
export function findArticleListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<ArticleBack[]>>> {
...
export function findArticleArchivesApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<ArticlePreviewDTO[]>>> {
...
export function findArticleHomeListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<ArticleHome[]>>> {
