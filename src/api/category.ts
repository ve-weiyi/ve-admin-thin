...
import type { BatchResult, Category, CategoryDetailsDTO } from "./types";
...
/** 批量删除文章分类 */
export function deleteCategoryByIdsApi(
  data: number[]
...
export function findCategoryListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<Category[]>>> {
...
export function findCategoryDetailsListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<CategoryDetailsDTO[]>>> {
