...
/** 批量删除评论 */
export function deleteCommentByIdsApi(
  data: number[]
...
export function findCommentListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<Comment[]>>> {
...
export function findCommentDetailsListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<CommentDTO[]>>> {
...
export function findCommentBackListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<CommentBackDTO[]>>> {
...
export function findCommentReplyListApi(
  id: number,
  page: PageQuery
): Promise<IApiResponseData<PageResult<ReplyDTO[]>>> {
