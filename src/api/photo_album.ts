...
import type { BatchResult, PhotoAlbum, PhotoAlbumDetailsDTO } from "./types";
...
/** 批量删除相册 */
export function deletePhotoAlbumByIdsApi(
  data: number[]
...
export function findPhotoAlbumListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<PhotoAlbum[]>>> {
...
export function findPhotoAlbumDetailsListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<PhotoAlbumDetailsDTO[]>>> {
