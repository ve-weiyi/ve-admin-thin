...
import type { BatchResult, Tag, TagDetailsDTO } from "./types";
...
/** 批量删除文章标签 */
export function deleteTagByIdsApi(
  data: number[]
...
export function findTagListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<Tag[]>>> {
...
export function findTagDetailsListApi(
  page: PageQuery
): Promise<IApiResponseData<PageResult<TagDetailsDTO[]>>> {
