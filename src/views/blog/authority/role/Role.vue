    ...
    >
      ...
      <el-tabs type="border-card">
        ...
        <el-tab-pane label="角色接口权限">
          <Resource
            ref="apis"
            :row="formData.resource_id_list"
            @changeRow="onResourceChange"
          />
        </el-tab-pane>
      </el-tabs>
      <template #footer>
...
function updateResources() {
  const v1 = activeResources.value
    ? JSON.stringify(activeResources.value.sort(fun))
    : "[]";
