    ...
    <div class="center-box">
      ...
      <div class="flex-row">
        ...
        <div class="card purple">
          ...
          <el-button class="btn" type="info" @click="bindHandle(1)">
            {{ set.phone ? "更换手机" : "去绑定" }}
          </el-button>
        </div>
        <!--实名认证-->
        ...
        <div class="card green">
          ...
          <el-button class="btn" type="info" @click="bindHandle(3)">
            {{ set.email ? "更换邮箱" : "去绑定" }}
          </el-button>
        </div>
        <!--个人信息-->
      ...
      <div v-loading="loading" class="card-section">
        <div class="login-title flex-row flex-between flex-vertical-center">
          ...
          <p style="cursor: pointer">
            <span class="right-tips" @click="router.push('/user/history')"
              >查看更多</span
            >
